...
namespace BandAppWeb.Controllers
{
    public class InstrumentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "idInstrument,instrument1")] Instrument instrument)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "idInstrument,instrument1")] Instrument instrument)
        {
            if (ModelState.IsValid)
            {
